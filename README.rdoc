...
== INSTALL
  ...
  gitolite_host="gitolite サーバーホスト or IP アドレス"


== 作成されるファイル

* ssh 鍵 : ~/.ssh/gitolite/<ユーザー名>[.pub]
...
gitolite サーバー上で、自分のユーザーアカウントから gitolite の 自分のユーザーアカウント名 ユーザーにアクセスできるようにする
